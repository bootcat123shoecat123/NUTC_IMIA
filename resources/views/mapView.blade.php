                                    ...
                                    <form method="post" action="/create/backMap">
                                        ...
                                        <div class="m-3">
                                            <div class="row">
                                                <div class="col-3">
                                                    <label for="exampleFormControlTextarea1" class="p-0 m-0"
                                                        style="font-size:2vh;text-align: left">建築名稱</label>
                                                </div>
                                            </div>
                                            <input type="text" class="form-control"
                                                aria-label="Text input with checkbox">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-1">
                                            <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                                data-target="<?php echo '#' . $modal . 'IM2'; ?>">
                                                🖊️
                                            </button>
                                            <div class="modal fade c0" id="<?php echo $modal . 'IM2'; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="<?php echo $modal . 'TitleIM2'; ?>" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content bg-d">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="<?php echo $modal . 'TitleIM2'; ?>">
                                                                {{ $item->name }}</h5>
                                                            <button type="button" class="close c0"
                            ...
                            <div class="col-5 border border-light rounded">
                                ...
                                @foreach ($value->IM5 as $item)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-1">
                                            <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                                data-target="<?php echo '#' . $modal . 'IM5'; ?>">
                                                🖊️
                                            </button>
                                            <div class="modal fade c0" id="<?php echo $modal . 'IM5'; ?>" tabindex="-1"
                                                role="dialog" aria-labelledby="<?php echo $modal . 'TitleIM5'; ?>" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content bg-d">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="<?php echo $modal . 'TitleIM5'; ?>">
                                                                {{ $item->name }}</h5>
                                                            <button type="button" class="close c0"
                                                                data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                ...
                                <div class="col-5 border border-light rounded">
                                    ...
                                    @foreach ($value->IA2 as $item)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                                    data-target="<?php echo '#' . $modal . 'IA2'; ?>">
                                                    🖊️
                                                </button>
                                                <div class="modal fade c0" id="<?php echo $modal . 'IA2'; ?>" tabindex="-1"
                                                    role="dialog" aria-labelledby="<?php echo $modal . 'TitleIA2'; ?>"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content bg-d">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="<?php echo $modal . 'TitleIA2'; ?>">
                                                                    {{ $item->name }}</h5>
                                                                <button type="button" class="close c0"
                                                                    data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="container">
                                                                    ...
                                                                    <form method="post" action="/backMap/Mupdate">
                                                                        ...
                                                                        <div class="modal-footer m-12">
                                                                            <input
                                                                                class="btn btn-primary pull-bottom w-100"
                                                                                type="submit">
                                                                        </div>
                                                                    </form>
                                    ...
                                    @foreach ($value->IA5 as $item)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-1">
                                                ...
                                                <div class="modal fade c0" id="<?php echo $modal . 'IA5'; ?>" tabindex="-1"
                                                    role="dialog" aria-labelledby="<?php echo $modal . 'TitleIA5'; ?>"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content bg-d">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="<?php echo $modal . 'TitleIA5'; ?>">
                                                                    {{ $item->name }}</h5>
                                                                <button type="button" class="close c0"
                                                                    data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
